...
const BuyRatioSchema = z.preprocess(
  (value) => {
...
export const TakerFilterValueSchema = z.object({
  ...
  minBuyVolumeUsd: z.union([z.null(), UsdAmountSchema]).optional().default(null),
  minTotalVolumeUsd: z.union([z.null(), UsdAmountSchema]).optional().default(null),
