...
/** Latest-value / trend calculations shared by the sidebar sections. */
function useSidebarCalculations({
  marketData,
  chartData,
  volumeData,
  bbData,
...
type SidebarCalculations = ReturnType<typeof useSidebarCalculations>

/** Price / market cap / 24h volume rows. */
...
/** 21-day support / resistance rows. */
function PriceLevelsSection({ calculations }: { calculations: SidebarCalculations }) {
  return (
...
/** Hull Suite / RSI-BB / divergence / money flow / wave trend rows. */
function TechnicalIndicatorsSection({
  ...
  calculations: SidebarCalculations
  marketData: MarketData
  divergence: ReturnType<typeof calculateDivergence> | null
}) {
  return (
...
/** Open interest / order flow / liquidations / trend summary rows. */
...
export function MarketMetricsSidebar({
  ...
  // Data calculations
  const calculations = useSidebarCalculations({
    marketData,
    chartData,
    volumeData,
    bbData,
  ...
  return (
    <div className="lg:col-span-1 space-y-6 overflow-hidden">
      <div className="">
        ...
        <MarketMetricsSection calculations={calculations} marketData={marketData} />

        <Divider />

        <PriceLevelsSection calculations={calculations} />
