...
export function ScreenerSmartPromptDialog({
  ...
  const applyServerActions = React.useCallback(
      ...
      for (const action of serverActions) {
        ...
        if (kind === "takerFilter") {
          ...
          const minBuyRatioRaw =
            record.minBuyRatio === null || typeof record.minBuyRatio === "number"
              ? record.minBuyRatio
              : null
          const minBuyVolumeUsdRaw =
            record.minBuyVolumeUsd === null || typeof record.minBuyVolumeUsd === "number"
              ? record.minBuyVolumeUsd
              : null
          const minTotalVolumeUsdRaw =
            record.minTotalVolumeUsd === null || typeof record.minTotalVolumeUsd === "number"
              ? record.minTotalVolumeUsd
              : null
          const minNetBuyUsdRaw =
            record.minNetBuyUsd === null || typeof record.minNetBuyUsd === "number"
              ? record.minNetBuyUsd
              : null
    ...
    [onChangeFilterChange, onSortByChange, onSortOrderChange, onTakerFilterChange],
  )
