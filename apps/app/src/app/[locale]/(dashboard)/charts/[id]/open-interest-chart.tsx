                ...
                <div className="px-4 py-3">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[11px] font-berkeley-mono text-white font-bold">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-[10px] font-berkeley-mono px-1.5 h-4 rounded ${tooltip.changePercent >= 0 ? 'bg-emerald-500/20 text-emerald-400' : 'bg-rose-500/20 text-rose-400'}`}>{tooltip.changePercent >= 0 ? '+' : ''}{tooltip.changePercent.toFixed(2)}%</span>
                    </div>
                  </div>
                </div>
              </div>
