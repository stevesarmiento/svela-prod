    ...
    return (
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          ref={ref}
          className={cn(
            "fixed left-[50%] top-[50%] z-[10001] grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] rounded-2xl border border-zinc-800/50 bg-background/60 backdrop-blur-sm duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-70 data-[state=open]:zoom-in-70 data-[state=closed]:slide-out-to-down-1/2 data-[state=closed]:slide-out-to-down-[48%] data-[state=open]:slide-in-from-down-1/2 data-[state=open]:slide-in-from-top-[0%]",
