...
import type { ConnectorClient, ConnectorState } from '@arma/connector'
...
/**
 * ArmaWebClient - A stateful client for managing the connection
  ...
  private initializeWallets() {
    ...
    try {
      ...
      if (!providedConnector) {
        throw new Error('ArmaProvider requires @arma/connector-kit AppProvider. Wrap your app with AppProvider and ensure connector is passed to Arma.')
      }
